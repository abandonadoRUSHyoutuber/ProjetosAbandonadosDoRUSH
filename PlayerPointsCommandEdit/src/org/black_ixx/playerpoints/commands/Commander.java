...
public class Commander extends CommandHandler {
    ...
    public Commander(PlayerPoints plugin) {
        ...
        // Register commands.
        registerCommand("dar", new GiveCommand());
        registerCommand("todos", new GiveAllCommand());
        registerCommand("retirar", new TakeCommand());
        registerCommand("mostrar", new LookCommand());
        registerCommand("pagar", new PayCommand());
        registerCommand("setar", new SetCommand());
        registerCommand("resetar", new ResetCommand());
        registerCommand("ver", new MeCommand());
        registerCommand("recarregar", new ReloadCommand());
